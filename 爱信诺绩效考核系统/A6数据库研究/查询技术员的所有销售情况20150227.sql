...
--(Ver2.4)根据收款日期和物品类别id来查询技术员的所有销售情况
...
--(Ver2.4)根据收款日期和物品类别id来查询技术员的"IT服务外包"销售情况
select emp.cCode as EMP_CODE,emp.cName AS EMP_NAME,SUM(dis2.iReceiveTotal) as MONEY from (
select * from(
select distinct dis_line.cGUID as dis_line_cGUID,dis_main.cEmpGUID,dis_line.cMatGUID,dis_line.iReceiveTotal from SA_DispatchLine dis_line
left join SA_Dispatch dis_main
...
--(Ver2.4)根据收款日期和物品类别id来查询技术员的"产业化产品"销售情况
select emp.cCode as EMP_CODE,emp.cName AS EMP_NAME,SUM(dis2.iReceiveTotal) as MONEY from (
select * from(
select distinct dis_line.cGUID as dis_line_cGUID,dis_main.cEmpGUID,dis_line.cMatGUID,dis_line.iReceiveTotal from SA_DispatchLine dis_line
left join SA_Dispatch dis_main
...
--(Ver2.4)根据收款日期和物品类别id来查询技术员的"企业管理软件"销售情况
select emp.cCode as EMP_CODE,emp.cName AS EMP_NAME,SUM(dis2.iReceiveTotal) as MONEY from (
select * from(
select distinct dis_line.cGUID as dis_line_cGUID,dis_main.cEmpGUID,dis_line.cMatGUID,dis_line.iReceiveTotal from SA_DispatchLine dis_line
left join SA_Dispatch dis_main
...
--(Ver2.4)根据收款日期和物品类别id来查询技术员的"文本组件"销售情况
select emp.cCode as EMP_CODE,emp.cName AS EMP_NAME,SUM(dis2.iReceiveTotal) as MONEY from (
select * from(
select distinct dis_line.cGUID as dis_line_cGUID,dis_main.cEmpGUID,dis_line.cMatGUID,dis_line.iReceiveTotal from SA_DispatchLine dis_line
left join SA_Dispatch dis_main
...
--(Ver2.5)根据收款日期和物品类别id来查询技术员的--剔除"服务费"的销售情况
select emp.cCode as EMP_CODE,emp.cName AS EMP_NAME,SUM(dis2.iReceiveTotal) as MONEY from (
select * from(
select distinct dis_line.cGUID as dis_line_cGUID,dis_main.cEmpGUID,dis_line.cMatGUID,dis_line.iReceiveTotal from SA_DispatchLine dis_line
left join SA_Dispatch dis_main
...
and not exists
/**排除服务费
剔除了174537133500159576旅馆业服务费,
剔除了174537133500157028增值税发票系统技术维护费
**/
...
--(Ver2.4)根据收款日期和物品类别id来查询"呼叫中心"的"服务费"收取户数
select emp.cCode as EMP_CODE,emp.cName AS EMP_NAME,SUM(dis2.iReceiveTotal) as MONEY from (
select * from(
...
--(Ver2.4)根据收款日期和物品类别id来查询技术员的"文本组件"销售提成
select emp.cCode as EMP_CODE,emp.cName AS EMP_NAME,SUM(dis2.iReceiveTotal) as MONEY from (
select * from(
