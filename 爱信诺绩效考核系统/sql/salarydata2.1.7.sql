...
INSERT INTO `author` VALUES ('46', '22', '角色授权', 'getRoleauthorlist');
INSERT INTO `author` VALUES ('47', '22', '修改授权信息', 'editRoleauthor');
...
INSERT INTO `employee` VALUES ('62', '5200086', '周利辉', '6', '1', '1', '0', '5200086');
INSERT INTO `employee` VALUES ('63', '5200018', '顾劲勇', '6', '1', '1', '0', '5200018');
INSERT INTO `employee` VALUES ('64', '5200315', '陈泊', '6', '1', '1', '0', '5200382');
INSERT INTO `employee` VALUES ('65', '5200422', '黎世萍', '6', '1', '1', '0', '5200422');
...
-- Records of report
-- ----------------------------
INSERT INTO `report` VALUES ('1', '查询奖金期间', 'select id,name,DATE_FORMAT(daystart,\'%Y-%m-%d\') as daystart,DATE_FORMAT(dayend,\'%Y-%m-%d\') as dayend from account', 'id,name,daystart,dayend', '编号,期间名称,开始日期,结束日期', '50,100,100,100', '0');
INSERT INTO `report` VALUES ('2', '查询操作员', 'select * from operator', 'id,name,pass', '操作员编号,操作员名称,操作员密码', '80,150,200', '0');
INSERT INTO `report` VALUES ('3', '查询人员', 'select emp.id,emp.name as empname,dept.name as deptname from employee emp\r\nleft join department dept\r\non emp.department_id=dept.id', 'id,empname,deptname', '人员编号,姓名,部门名称', '80,200,150', '0');
