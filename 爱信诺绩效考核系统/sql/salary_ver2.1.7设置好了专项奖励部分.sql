...
) ENGINE=InnoDB AUTO_INCREMENT=23 DEFAULT CHARSET=utf8 COMMENT='工资项目';
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='工资项目动态SQL公式';
...
INSERT INTO `salary_item` VALUES ('1','工作量','0','0','1','0'), ('2','工作量任务','0','0','1','0'), ('3','工作量奖励','0','0','1','0'), ('4','服务费户数','0','0','1','0'), ('5','服务费户数任务','0','0','1','0'), ('6','服务费奖励','0','0','1','0'), ('7','二次销售','0','0','1','0'), ('8','二次销售任务','0','0','1','0'), ('9','二次销售奖励','0','0','1','0'), ('10','IT外包销售额','0','0','1','0'), ('11','IT外包奖励专项','0','0','1','0'), ('12','产业化招生销售额','0','0','1','0'), ('13','产业化招生奖励专项','0','0','1','0'), ('14','企业管理软件销售额','0','0','1','0'), ('15','企业管理软件奖励专项','0','0','1','0'), ('16','文本组件销售额','0','0','1','0'), ('17','文本组件奖励专项','0','0','1','0'), ('18','客服组奖励专项','0','0','1','0'), ('19','发票查询软件奖励专项','0','0','1','0'), ('20','销售超额奖励专项','1','0','1','0'), ('21','销售超额金盾奖励专项','1','0','1','0'), ('22','专项奖励合计','1','0','1','0');
INSERT INTO `salary_item_expression` VALUES ('1','20','销售超额奖励专项','case when fnGetSalaryMoney(:account_id,:emp_id,7)>=100000 then 1500  when fnGetSalaryMoney(:account_id,:emp_id,7)>=50000 then 1000  when fnGetSalaryMoney(:account_id,:emp_id,7)>=30000 then 500  when fnGetSalaryMoney(:account_id,:emp_id,7)>=25000 then 300 end','销售超额奖励专项'), ('2','21','金盾专属销售超额奖励专项','if(fnGetSalaryMoney(:account_id,:emp_id,7)>=6000,150,0)','金盾专属销售超额奖励专项'), ('3','22','专项奖励合计','fnGetSalaryMoney(:account_id,:emp_id,11)+fnGetSalaryMoney(:account_id,:emp_id,13)+fnGetSalaryMoney(:account_id,:emp_id,15)+fnGetSalaryMoney(:account_id,:emp_id,17)+fnGetSalaryMoney(:account_id,:emp_id,18)+fnGetSalaryMoney(:account_id,:emp_id,19)+fnGetSalaryMoney(:account_id,:emp_id,20)+fnGetSalaryMoney(:account_id,:emp_id,21)','专项奖励合计');
INSERT INTO `salary_item_unit` VALUES ('1','金税组计算模板','1,3,'), ('2','金盾组计算模板','1,2,3,'), ('3','呼叫中心计算模板','1,3,'), ('4','客服组计算模板','1,3,'), ('5','驻税主管计算模板','1,3,');
