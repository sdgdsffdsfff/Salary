...
<div style="padding:20px;">
	<form id="addSalaryitemexpressionForm" action="addSalaryitemexpression" method="POST" >
		<table cellpadding="5" >
			<tr>
				<td>奖金项目:</td>
				<td>
				<select class="easyui-combobox" name="salary_item_expression.salary_item_id" 
			...
			<tr>
				<td>公式名称:</td>
				<td>
					<input type="text" class="easyui-textbox" name="salary_item_expression.name" 
					data-options="
					required:true,
...
<script type="text/javascript">
	function submit(){
		var isValid=$('#addSalaryitemexpressionForm').form('validate');
		if(!isValid){
		...
		$('#addSalaryitemexpressionForm').submit();
