...
<div style="padding:20px;">
	<form id="editSalaryitemForm" action="editSalaryitem" method="POST" >
		<input type="hidden" name="salary_item.id" value='<s:property value="salary_item.id" />' />
		<input type="hidden" name="salary_item.isdel" value='<s:property value="salary_item.isdel" />' />
		...
		<table cellpadding="5" >
			...
			<tr>
				...
				<td>
					...
					value:<s:property value="salary_item.level" />' >
			...
			<tr>
				...
				<td>
					...
					data-options='
					required:true,width:150,
					value:<s:property value="salary_item.isshow" />' >
			...
			<tr>
				...
				<td>
					...
					value:<s:property value="salary_item.isedit" />' >
			...
			<tr>
				...
				<td>
					...
					data-options='required:true,width:150,
					value:<s:property value="salary_item.issum" />' >
